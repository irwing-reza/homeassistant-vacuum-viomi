...
[![Validation flow](https://github.com/irwing-reza/homeassistant-vacuum-viomi/actions/workflows/workflow.yaml/badge.svg)](https://github.com/irwing-reza/homeassistant-vacuum-viomi/actions/workflows/workflow.yaml)
...
Install it through HACS by adding this as a custom repository: https://github.com/irwing-reza/homeassistant-vacuum-viomi, go to the integrations page in your configuration, click on the `Add Integration` button in the bottom right corner of a screen, and search for `Xiaomi Viomi Vacuum`.
